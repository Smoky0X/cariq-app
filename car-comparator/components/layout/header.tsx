...
import { Zap, User, Settings, LogOut, Crown, BarChart3, Heart, Bell, MessageSquare, Menu, X } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/dealers" className="text-gray-600 hover:text-gray-900 transition-colors">
              Concessionnaires
            </Link>
            <Link href="/financing" className="text-gray-600 hover:text-gray-900 transition-colors">
              Financement
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t bg-white py-4">
            <nav className="flex flex-col space-y-3">
              ...
              <Link href="/dealers" className="text-gray-600 hover:text-gray-900 px-2 py-1">
                Concessionnaires
              </Link>
              <Link href="/financing" className="text-gray-600 hover:text-gray-900 px-2 py-1">
                Financement
              </Link>
              <Link href="/reviews" className="text-gray-600 hover:text-gray-900 px-2 py-1">
                Avis
              </Link>
